                ...
                <div className="relative overflow-hidden rounded-lg shadow-lg h-full">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="text-center text-white p-6">
                            ...
                            <a href="/products/earrings" className="inline-flex items-center px-6 py-2 text-sm font-semibold text-black bg-white rounded-lg hover:bg-gray-200">
                                Gözat
                            </a>
                        </div>
                    </div>
                ...
                <div className="relative overflow-hidden rounded-lg shadow-lg">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="text-center text-white p-6">
                            ...
                            <p className="text-sm mb-4">925 Ayar Saf Gümüş</p>
                            <a href="/products/rings" className="inline-flex items-center px-6 py-2 text-sm font-semibold text-black bg-white rounded-lg hover:bg-gray-200">
                                Gözat
                            </a>
                        </div>
                    </div>
                ...
                <div className="relative overflow-hidden rounded-lg shadow-lg">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="text-center text-white p-6">
                            ...
                            <a href="/products/set" className="inline-flex items-center px-6 py-2 text-sm font-semibold text-black bg-white rounded-lg hover:bg-gray-200">
                                Gözat
                            </a>
                        </div>
                    </div>
